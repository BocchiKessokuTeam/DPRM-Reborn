...
public class StonecuttingContainerProvider implements MenuProvider {
    @Nullable
    @Override
    public AbstractContainerMenu createMenu(int sycID, Inventory playerInventory, Player player) {
        FriendlyByteBuf FriendlyByteBuf = new FriendlyByteBuf(Unpooled.buffer());
        return new StonecuttingContainer(sycID,playerInventory,FriendlyByteBuf);
    }

    @Override
    public Component getDisplayName() {
        return new TranslatableComponent("gui."+ DPRMReborn.MODID +".stonecutting.title");
    }
}
