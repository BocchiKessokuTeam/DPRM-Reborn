...
import org.bocchikessokuteam.dprmreborn.containerprovider.SmithingContainerProvider;
...
public class SmithingCommand implements Command<CommandSourceStack> {
    ...
    public int run(CommandContext<CommandSourceStack> context) throws CommandSyntaxException {
        ...
        NetworkHooks.openGui(serverPlayer,new SmithingContainerProvider(), (FriendlyByteBuf) -> {
