...
import org.bocchikessokuteam.dprmreborn.containerprovider.StonecuttingContainerProvider;
import org.bocchikessokuteam.dprmreborn.file.JsonManager;

import java.io.IOException;

public class StonecuttingCommand implements Command<CommandSourceStack> {
...
//        String datapacksDirPath = serverPlayer.getServer().getDataDirectory().getPath() + "\\datapacks";
        ...
        NetworkHooks.openGui(serverPlayer,new StonecuttingContainerProvider(), (FriendlyByteBuf) -> {
